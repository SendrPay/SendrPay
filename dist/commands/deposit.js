...
exports.commandDeposit = commandDeposit;
const prisma_1 = require("../infra/prisma");
const logger_1 = require("../infra/logger");
const message_templates_1 = require("../core/message-templates");
async function commandDeposit(ctx) {
    const chat = ctx.chat;
    if (!chat) {
    ...
    logger_1.logger.info("Deposit command received");
    try {
        // Get user wallet
        ...
        const baseMessage = message_templates_1.messages.dm.deposit_address(messageData);
...
*Your wallet: ${shortAddress}*`;
        ...
        logger_1.logger.error("Deposit command error:", error);
